...
def support_work_body(t, code):
    ...
    rows = (row(SPONSORS_LIVE, "https://github.com/sponsors/verdettoqr", "GitHub Sponsors", t["r_sponsors"]) + "\n"
            + row(LIBERAPAY_LIVE, LIBERAPAY_URL, "Liberapay", t["r_liberapay"]) + "\n"
