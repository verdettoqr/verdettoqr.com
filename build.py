...
SUPPORT_WORK_T = {
 "en": {
  ...
  "fdroid_p": "In this order: {LIBERAPAY} (any amount, weekly, monthly or yearly), {CARD} (once, from $2.99 or an amount you type), {SPONSORS} (from $1 once, or monthly at the same stops as the app).",
  "github_h": "If you installed from GitHub",
  "github_p": "In this order: {SPONSORS} (from $1 once, or monthly at the same stops as the app), {CARD} (once, from $2.99 or an amount you type), {LIBERAPAY} (any amount, weekly, monthly or yearly).",
 ...
 "de": {
  ...
  "fdroid_p": "In dieser Reihenfolge: {LIBERAPAY} (jeder Betrag, wöchentlich, monatlich oder jährlich), {CARD} (einmal, ab 2,99 $ oder ein Betrag, den du eingibst), {SPONSORS} (ab 1 $ einmal oder monatlich zu denselben Stufen wie in der App).",
  "github_h": "Wenn du über GitHub installiert hast",
  "github_p": "In dieser Reihenfolge: {SPONSORS} (ab 1 $ einmal oder monatlich zu denselben Stufen wie in der App), {CARD} (einmal, ab 2,99 $ oder ein Betrag, den du eingibst), {LIBERAPAY} (jeder Betrag, wöchentlich, monatlich oder jährlich).",
 ...
 "es": {
  ...
  "fdroid_p": "En este orden: {LIBERAPAY} (cualquier importe, cada semana, cada mes o cada año), {CARD} (una vez, desde 2,99 $ o un importe que escribes), {SPONSORS} (desde 1 $ una vez, o cada mes en los mismos tramos que la aplicación).",
  "github_h": "Si instalaste desde GitHub",
  "github_p": "En este orden: {SPONSORS} (desde 1 $ una vez, o cada mes en los mismos tramos que la aplicación), {CARD} (una vez, desde 2,99 $ o un importe que escribes), {LIBERAPAY} (cualquier importe, cada semana, cada mes o cada año).",
 ...
 "fr": {
  ...
  "fdroid_p": "Dans cet ordre : {LIBERAPAY} (n'importe quel montant, chaque semaine, chaque mois ou chaque année), {CARD} (une fois, dès 2,99 $ ou un montant que tu saisis), {SPONSORS} (dès 1 $ une fois, ou chaque mois aux mêmes paliers que l'application).",
  "github_h": "Si tu as installé depuis GitHub",
  "github_p": "Dans cet ordre : {SPONSORS} (dès 1 $ une fois, ou chaque mois aux mêmes paliers que l'application), {CARD} (une fois, dès 2,99 $ ou un montant que tu saisis), {LIBERAPAY} (n'importe quel montant, chaque semaine, chaque mois ou chaque année).",
 ...
 "pt-BR": {
  ...
  "fdroid_p": "Nesta ordem: {LIBERAPAY} (qualquer valor, toda semana, todo mês ou todo ano), {CARD} (uma vez, a partir de US$ 2,99 ou um valor que você digita), {SPONSORS} (a partir de US$ 1 uma vez, ou todo mês nos mesmos valores do app).",
  "github_h": "Se você instalou pelo GitHub",
  "github_p": "Nesta ordem: {SPONSORS} (a partir de US$ 1 uma vez, ou todo mês nos mesmos valores do app), {CARD} (uma vez, a partir de US$ 2,99 ou um valor que você digita), {LIBERAPAY} (qualquer valor, toda semana, todo mês ou todo ano).",
 ...
 "id": {
  ...
  "fdroid_p": "Dalam urutan ini: {LIBERAPAY} (berapa pun, mingguan, bulanan, atau tahunan), {CARD} (sekali, mulai $2,99 atau jumlah yang kamu ketik), {SPONSORS} (mulai $1 sekali, atau bulanan pada tingkatan yang sama dengan aplikasi).",
  "github_h": "Jika kamu memasang dari GitHub",
  "github_p": "Dalam urutan ini: {SPONSORS} (mulai $1 sekali, atau bulanan pada tingkatan yang sama dengan aplikasi), {CARD} (sekali, mulai $2,99 atau jumlah yang kamu ketik), {LIBERAPAY} (berapa pun, mingguan, bulanan, atau tahunan).",
  "card_l": "tautan kartu",
 ...
 "ru": {
  ...
  "fdroid_p": "В таком порядке: {LIBERAPAY} (любая сумма, еженедельно, ежемесячно или ежегодно), {CARD} (разово, от 2,99 $ или сумма, которую вы вводите), {SPONSORS} (от 1 $ разово или ежемесячно на тех же ступенях, что и в приложении).",
  "github_h": "Если вы установили с GitHub",
  "github_p": "В таком порядке: {SPONSORS} (от 1 $ разово или ежемесячно на тех же ступенях, что и в приложении), {CARD} (разово, от 2,99 $ или сумма, которую вы вводите), {LIBERAPAY} (любая сумма, еженедельно, ежемесячно или ежегодно).",
 ...
 "hi": {
  ...
  "fdroid_p": "इस क्रम में: {LIBERAPAY} (कोई भी रकम, हर हफ़्ते, हर महीने या हर साल), {CARD} (एक बार, $2.99 से या आपकी लिखी कोई रकम), {SPONSORS} ($1 से एक बार, या ऐप के समान स्तरों पर हर महीने)।",
  "github_h": "यदि आपने GitHub से इंस्टॉल किया है",
  "github_p": "इस क्रम में: {SPONSORS} ($1 से एक बार, या ऐप के समान स्तरों पर हर महीने), {CARD} (एक बार, $2.99 से या आपकी लिखी कोई रकम), {LIBERAPAY} (कोई भी रकम, हर हफ़्ते, हर महीने या हर साल)।",
  "card_l": "कार्ड लिंक",
 ...
 "ja": {
  ...
  "fdroid_p": "この順で: {LIBERAPAY}(額は自由、毎週・毎月・毎年)、{CARD}(一度だけ、2.99 ドルから、または入力した額)、{SPONSORS}(1 ドルから一度だけ、または毎月アプリと同じ段階で)。",
  "github_h": "GitHub からインストールした場合",
  "github_p": "この順で: {SPONSORS}(1 ドルから一度だけ、または毎月アプリと同じ段階で)、{CARD}(一度だけ、2.99 ドルから、または入力した額)、{LIBERAPAY}(額は自由、毎週・毎月・毎年)。",
  "card_l": "カード決済のリンク",
 ...
 "zh-Hans": {
  ...
  "fdroid_p": "按此顺序：{LIBERAPAY}（任意金额，每周、每月或每年）、{CARD}（一次，2.99 美元起或自行输入的金额）、{SPONSORS}（1 美元起一次，或按与应用相同的档位每月支持）。",
  "github_h": "如果你从 GitHub 安装",
  "github_p": "按此顺序：{SPONSORS}（1 美元起一次，或按与应用相同的档位每月支持）、{CARD}（一次，2.99 美元起或自行输入的金额）、{LIBERAPAY}（任意金额，每周、每月或每年）。",
  "card_l": "银行卡链接",
 ...
 "ar": {
  ...
  "fdroid_p": "بهذا الترتيب: {LIBERAPAY} (أي مبلغ، أسبوعيًا أو شهريًا أو سنويًا)، {CARD} (مرة واحدة، من 2.99 دولار أو مبلغ تكتبه)، {SPONSORS} (من دولار واحد مرة واحدة، أو شهريًا بنفس درجات التطبيق).",
  "github_h": "إذا ثبّت التطبيق من GitHub",
  "github_p": "بهذا الترتيب: {SPONSORS} (من دولار واحد مرة واحدة، أو شهريًا بنفس درجات التطبيق)، {CARD} (مرة واحدة، من 2.99 دولار أو مبلغ تكتبه)، {LIBERAPAY} (أي مبلغ، أسبوعيًا أو شهريًا أو سنويًا).",
